...
interface DeeDooBackerTest01Interface extends ethers.utils.Interface {
  functions: {
...
export class DeeDooBackerTest01 extends BaseContract {
  ...
  interface: DeeDooBackerTest01Interface;
