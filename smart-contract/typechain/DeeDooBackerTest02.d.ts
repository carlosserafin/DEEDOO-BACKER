...
interface DeeDooBackerTest02Interface extends ethers.utils.Interface {
  functions: {
    ...
    "backerMint(uint256)": FunctionFragment;
    "backerMintEnabled()": FunctionFragment;
    ...
    "getTotalBackForCourse(uint256)": FunctionFragment;
    "getTotalBackForCourseByWalletAddress(uint256,address)": FunctionFragment;
    ...
    "mapBackingAmount(uint256)": FunctionFragment;
    "mapBackingCourseTokenId(uint256)": FunctionFragment;
    ...
    "setBackertMintEnabled(bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "backerMint",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "backerMintEnabled",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "getTotalBackForCourse",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getTotalBackForCourseByWalletAddress",
  ...
  encodeFunctionData(
    functionFragment: "mapBackingAmount",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "mapBackingCourseTokenId",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setBackertMintEnabled",
    values: [boolean]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "backerMint", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "backerMintEnabled",
    data: BytesLike
  ): Result;
...
export class DeeDooBackerTest02 extends BaseContract {
  ...
  interface: DeeDooBackerTest02Interface;
  ...
  functions: {
    ...
    backerMint(
      _courseTokenId: BigNumberish,
      overrides?: PayableOverrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    backerMintEnabled(overrides?: CallOverrides): Promise<[boolean]>;
    ...
    getTotalBackForCourse(
      _courseTokenId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    getTotalBackForCourseByWalletAddress(
      _courseTokenId: BigNumberish,
      _backerAddress: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  ...
  estimateGas: {
    ...
    backerMintEnabled(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    backerMintEnabled(overrides?: CallOverrides): Promise<PopulatedTransaction>;
