...
interface DeeDooTeacherTest01Interface extends ethers.utils.Interface {
  functions: {
    ...
    "courseName(uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "courseName", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getApproved",
    data: BytesLike
  ): Result;
...
export class DeeDooTeacherTest01 extends BaseContract {
  ...
  interface: DeeDooTeacherTest01Interface;
  ...
  courseName(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
